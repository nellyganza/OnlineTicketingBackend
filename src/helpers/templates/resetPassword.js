    ...
    <body>
        <div className="wrapper">
          ...
          <center> <div className="content">
            ...
            <br>
            <a href="${link}" className="button">Reset my password</a>
        </div></center>
        </div>
    </body>
    </html>`;
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Hello ${emailData.name} You have
